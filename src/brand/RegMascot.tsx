import useMascotGreeting from './useMascotGreeting';
...
export default function RegMascot({ size = 210, className = "", greetOnEntry = false }: RegMascotProps) {
  ...
  return (
    <svg
      ref={greetingRef}
      data-greeting={greetOnEntry ? 'waiting' : undefined}
      aria-hidden="true"
      className={className}
      width={size}
      height={size}
    ...
    >
      <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        ...
        <g data-reg-eye="" style={{ transformBox: 'view-box', transformOrigin: '99px 83px' }}>
        ...
        <g data-reg-arm="" style={{ transformBox: 'view-box', transformOrigin: '177px 160px' }}>
